...
Version  : 24.12.3
Release  : 61
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kdesdk-kio-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kdesdk-kio-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kdesdk-kio-24.12.3.tar.xz.sig
...
%setup -q -n kdesdk-kio-24.12.3
cd %{_builddir}/kdesdk-kio-24.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742540358
mkdir -p clr-build
pushd clr-build

...
Version  : 24.12.2
Release  : 60
URL      : https://download.kde.org/stable/release-service/24.12.2/src/kdesdk-kio-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kdesdk-kio-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kdesdk-kio-24.12.2.tar.xz.sig
...
%setup -q -n kdesdk-kio-24.12.2
cd %{_builddir}/kdesdk-kio-24.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738995213
mkdir -p clr-build
pushd clr-build

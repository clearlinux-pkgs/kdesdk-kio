...
Version  : 25.04.0
Release  : 62
URL      : https://download.kde.org/stable/release-service/25.04.0/src/kdesdk-kio-25.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kdesdk-kio-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kdesdk-kio-25.04.0.tar.xz.sig
...
%setup -q -n kdesdk-kio-25.04.0
cd %{_builddir}/kdesdk-kio-25.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744950880
mkdir -p clr-build
pushd clr-build

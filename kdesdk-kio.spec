...
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kdesdk-kio-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kdesdk-kio-24.08.1.tar.xz.sig
...
%setup -q -n kdesdk-kio-24.08.1
cd %{_builddir}/kdesdk-kio-24.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726256145
mkdir -p clr-build
pushd clr-build

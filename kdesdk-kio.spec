...
Version  : 25.04.2
Release  : 64
URL      : https://download.kde.org/stable/release-service/25.04.2/src/kdesdk-kio-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kdesdk-kio-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kdesdk-kio-25.04.2.tar.xz.sig
...
%setup -q -n kdesdk-kio-25.04.2
cd %{_builddir}/kdesdk-kio-25.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749530391
mkdir -p clr-build
pushd clr-build

...
Version  : 24.05.0
Release  : 48
URL      : https://download.kde.org/stable/release-service/24.05.0/src/kdesdk-kio-24.05.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/kdesdk-kio-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/kdesdk-kio-24.05.0.tar.xz.sig
...
%setup -q -n kdesdk-kio-24.05.0
cd %{_builddir}/kdesdk-kio-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716589941
mkdir -p clr-build
pushd clr-build

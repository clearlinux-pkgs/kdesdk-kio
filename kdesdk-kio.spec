...
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/kdesdk-kio-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/kdesdk-kio-23.08.4.tar.xz.sig
...
%prep
%setup -q -n kdesdk-kio-23.08.4
cd %{_builddir}/kdesdk-kio-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707840833
mkdir -p clr-build
pushd clr-build

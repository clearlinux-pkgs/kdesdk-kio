...
Version  : 20.08.2
Release  : 23
URL      : https://download.kde.org/stable/release-service/20.08.2/src/kdesdk-kioslaves-20.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/kdesdk-kioslaves-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/kdesdk-kioslaves-20.08.2.tar.xz.sig
...
%prep
%setup -q -n kdesdk-kioslaves-20.08.2
cd %{_builddir}/kdesdk-kioslaves-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602642388
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdesdk-kioslaves-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/kdesdk-kioslaves/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/kdesdk-kioslaves-20.08.2/perldoc/COPYING %{buildroot}/usr/share/package-licenses/kdesdk-kioslaves/d6458d52bfead6f1399b865f1aeea0caa639ef6c
pushd clr-build
%make_install
popd

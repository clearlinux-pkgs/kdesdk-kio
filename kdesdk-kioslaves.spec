...
Source0  : https://download.kde.org/stable/release-service/22.04.0/src/kdesdk-kioslaves-22.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.0/src/kdesdk-kioslaves-22.04.0.tar.xz.sig
...
%prep
%setup -q -n kdesdk-kioslaves-22.04.0
cd %{_builddir}/kdesdk-kioslaves-22.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650675715
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdesdk-kioslaves-22.04.0/COPYING %{buildroot}/usr/share/package-licenses/kdesdk-kioslaves/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/kdesdk-kioslaves-22.04.0/perldoc/COPYING %{buildroot}/usr/share/package-licenses/kdesdk-kioslaves/d6458d52bfead6f1399b865f1aeea0caa639ef6c
pushd clr-build
%make_install
popd

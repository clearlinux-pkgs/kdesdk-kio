...
Source0  : https://download.kde.org/stable/applications/19.04.3/src/kdesdk-kioslaves-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/kdesdk-kioslaves-19.04.3.tar.xz.sig
...
%prep
%setup -q -n kdesdk-kioslaves-19.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562868192
mkdir -p clr-build
pushd clr-build

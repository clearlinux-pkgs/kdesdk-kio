...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kdesdk-kioslaves-21.12.0.tar.xz
...
%prep
%setup -q -n kdesdk-kioslaves-21.12.0
cd %{_builddir}/kdesdk-kioslaves-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639635837
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdesdk-kioslaves-21.12.0/COPYING %{buildroot}/usr/share/package-licenses/kdesdk-kioslaves/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/kdesdk-kioslaves-21.12.0/perldoc/COPYING %{buildroot}/usr/share/package-licenses/kdesdk-kioslaves/d6458d52bfead6f1399b865f1aeea0caa639ef6c
pushd clr-build
%make_install
popd

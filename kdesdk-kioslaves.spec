...
Version  : 21.12.1
Release  : 35
URL      : https://download.kde.org/stable/release-service/21.12.1/src/kdesdk-kioslaves-21.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.1/src/kdesdk-kioslaves-21.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.1/src/kdesdk-kioslaves-21.12.1.tar.xz.sig
...
%prep
%setup -q -n kdesdk-kioslaves-21.12.1
cd %{_builddir}/kdesdk-kioslaves-21.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641963941
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdesdk-kioslaves-21.12.1/COPYING %{buildroot}/usr/share/package-licenses/kdesdk-kioslaves/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/kdesdk-kioslaves-21.12.1/perldoc/COPYING %{buildroot}/usr/share/package-licenses/kdesdk-kioslaves/d6458d52bfead6f1399b865f1aeea0caa639ef6c
pushd clr-build
%make_install
popd
